...
public interface BloomBouquetProjectRepository extends JpaRepository<BloomBouquetProject, Long> {
    ...
    Optional<BloomBouquetProject> findByTeam_IdAndSlug(Long teamId, String slug);
    ...
    default Optional<BloomBouquetProject> findByTeamIdAndSlug(Long teamId, String slug) {
        return findByTeam_IdAndSlug(teamId, slug);
    }

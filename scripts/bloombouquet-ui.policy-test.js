...
test('BloomBouquet shares one thin-border editorial visual system', () => {
  ...
  assert.match(css, /bouquet-metric strong\s*\{[^}]*font-size:\s*21px/s);
  ...
  assert.match(css, /bouquet-project-visual-copy strong\s*\{[^}]*font-size:\s*clamp\(22px,\s*2\.8vw,\s*36px\)/s);

...
- [x] **Step 3: Implement minimal version-1 contracts**
...
- [x] **Step 4: Re-run focused validation and verify GREEN**
...
- [x] **Step 2: Run focused artifact test and verify RED**
...
- [x] **Step 3: Implement durable files**
...
- [x] **Step 4: Re-run artifact and completion tests**
...
- [x] **Step 4: Re-run adapter test and verify GREEN**
...
- [x] **Step 2: Run focused history/identity suites**
...
- Task 1 contracts/validators implemented and focused validation passed.
- Task 2 identity-bound persistence implemented; duplicate IDs, cross-run writes, unbound writes, unknown-failure recovery, and write-once run result are covered.
- Task 3 pure adapters implemented for `AgentDecision`, `FailureRouteRecord`, and applied `ProjectReplanRecord`; existing Bloom runtime records remain authoritative in their current paths.

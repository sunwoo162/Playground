...
- [ ] **Step 3: Implement minimal safe snapshot writer**
...
- [ ] **Step 4: Run focused test and full Bloom policy tests**
...
- [ ] **Step 1: Add failing append-only tests**
...
- [ ] **Step 1: Add failing reconstruction test**

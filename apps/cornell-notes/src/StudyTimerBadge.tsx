...
export function StudyTimerBadge() {
  ...
  return (
    <a href="/apps/study-planner/" style={{
      fontSize: '0.78rem', fontWeight: 600, color: '#2ed573',
      background: 'rgba(46,213,115,0.1)', border: '1px solid rgba(46,213,115,0.4)',
      borderRadius: '12px', padding: '4px 10px', whiteSpace: 'nowrap', textDecoration: 'none',
    }}>⏱️ {fmt(elapsed)}</a>
  );
}
